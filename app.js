...
const UI_STRINGS = {
  ...
  allergenTrace: {
    it: "Alcuni piatti possono contenere tracce di allergeni.",
    en: "Some dishes may contain traces of allergens.",
  },
  allergenContact: {
    it: "Per informazioni dettagliate rivolgersi al personale di sala.",
    en: "For detailed information, please ask our staff.",
  },
  ...
  a1: { it: "Glutine", en: "Gluten" },
  a2: { it: "Crostacei", en: "Crustaceans" },
  a3: { it: "Uova", en: "Eggs" },
  a4: { it: "Pesce", en: "Fish" },
  a5: { it: "Arachidi", en: "Peanuts" },
  a6: { it: "Soia", en: "Soy" },
  a7: { it: "Latte e derivati", en: "Milk" },
  a8: { it: "Frutta a guscio", en: "Tree Nuts" },
  a9: { it: "Sedano", en: "Celery" },
  a10: { it: "Senape", en: "Mustard" },
  a11: { it: "Semi di sesamo", en: "Sesame" },
  a12: { it: "Solfiti", en: "Sulphites" },
...
function renderMenu(category) {
  ...
  data.sections.forEach((section) => {
    ...
    titleEl.textContent =
      section.title !== null && typeof section.title === "object"
